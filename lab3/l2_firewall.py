...
# Setup a list storing the firewall ALLOW connectivity between host (1,3) and (2,4)
allow_connected_list = [
  (EthAddr('00:00:00:00:00:01'), EthAddr('00:00:00:00:00:03')),
  (EthAddr('00:00:00:00:00:03'), EthAddr('00:00:00:00:00:01')),
  (EthAddr('00:00:00:00:00:02'), EthAddr('00:00:00:00:00:04')),
  (EthAddr('00:00:00:00:00:04'), EthAddr('00:00:00:00:00:02')),
]
...
class LearningSwitch (object):
  ...
  def __init__ (self, connection, transparent):
    ...
    self.AddRule('00-00-00-00-00-02',EthAddr('00:00:00:00:00:02'))
    ...
    self.AddRule('00-00-00-00-00-03',EthAddr('00:00:00:00:00:02'))
    self.AddRule('00-00-00-00-00-03',EthAddr('00:00:00:00:00:03'))
    self.AddRule('00-00-00-00-00-03',EthAddr('00:00:00:00:00:04'))
    
    self.AddRule('00-00-00-00-00-04',EthAddr('00:00:00:00:00:01'))
    self.AddRule('00-00-00-00-00-04',EthAddr('00:00:00:00:00:02'))
    self.AddRule('00-00-00-00-00-04',EthAddr('00:00:00:00:00:03'))
    self.AddRule('00-00-00-00-00-04',EthAddr('00:00:00:00:00:04'))
  ...
  def _handle_PacketIn (self, event):
    ...
    if packet.dst.is_multicast:
      ...
      if packet.dst not in self.macToPort: # 4
        ...
        # check if the source and destination MAC address 
        # are in the firewall ALLOW list for communication
        # if not, DROP the packets
        if ((packet.src, packet.dst) not in allow_connected_list):
          log.debug("{} not satisfy: DROP".format((packet.src, packet.dst)))
          drop()
          return
        else:
